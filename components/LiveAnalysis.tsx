...
interface AnalysisData {
  ...
  technicalSignals: Array<{ signal: string; type: string }>;
}
...
const LiveAnalysis: React.FC<{ data: AnalysisData; onClose: () => void }> = ({ data, onClose }) => {
  ...
  return (
    <div className="mt-10 animate-fade-in-up text-left">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {/* 4. Backtest Stats (Full Width on mobile, spans 3 on large if we had 4 cols, fitting in row 2 here) */}
